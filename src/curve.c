...
const uint16_t s_cap_list_chg[TEMP_POINT_NUM][CUR_POINT_NUM] = {
    ...
    [5][0] = 1027,      [5][1] = 1031,      [5][2] = 1027,          [5][3] = 0,         [5][4] = 1026,                       // 45
...
const uint16_t* s_chg_curve[TEMP_POINT_NUM][CUR_POINT_NUM]= 
{
    ...
    [5][0] = v_45d1c_chg,       [5][1] = v_45d2c_chg,       [5][2] = v_45d3c_chg,       [5][3] = NULL,              [5][4] = v_45d5c_chg,                   // 45
...
const int16_t* s_chg_curve_k[TEMP_POINT_NUM][CUR_POINT_NUM] = 
{
    ...
    [5][0] = k_45d1c_chg,       [5][1] = k_45d2c_chg,       [5][2] = k_45d3c_chg,       [5][3] = NULL,              [5][4] = k_45d5c_chg,                   // 45
    [6][0] = NULL,              [6][1] = NULL,              [6][2] = NULL,              [6][3] = NULL,              [6][4] = NULL,                          // 55
...
const uint16_t* s_dsg_curve[TEMP_POINT_NUM][CUR_POINT_NUM] = 
{
   /*  0.1C                     0.2 C                       0.3 C                      0.4 C                             0.5C                              */
    ...
    [2][0] = v_15d1c_dsg,       [2][1] = v_15d2c_dsg,       [2][2] = v_15d3c_dsg,       [2][3] = NULL,              [2][4] = v_15d5c_dsg,                   // 15
    [3][0] = v_25d1c_dsg,       [3][1] = v_25d2c_dsg,       [3][2] = v_25d3c_dsg,       [3][3] = v_25d4c_dsg,       [3][4] = v_25d5c_dsg,                   // 25    
    [4][0] = v_35d1c_dsg,       [4][1] = v_35d2c_dsg,       [4][2] = v_35d3c_dsg,       [4][3] = v_35d4c_dsg,       [4][4] = v_35d5c_dsg,                   // 35
    [5][0] = v_45d1c_dsg,       [5][1] = v_45d2c_dsg,       [5][2] = v_45d3c_dsg,       [5][3] = NULL,              [5][4] = v_45d5c_dsg,                   // 45
    [6][0] = NULL,              [6][1] = NULL,              [6][2] = NULL,              [6][3] = NULL,              [6][4] = NULL,                          // 55
};
...
const int16_t* s_dsg_curve_k[TEMP_POINT_NUM][CUR_POINT_NUM] = 
{
    ...
    [2][0] = k_15d1c_dsg,       [2][1] = k_15d2c_dsg,       [2][2] = k_15d3c_dsg,       [2][3] = NULL,              [2][4] = k_15d5c_dsg,                   // 15
    [3][0] = k_25d1c_dsg,       [3][1] = k_25d2c_dsg,       [3][2] = k_25d3c_dsg,       [3][3] = k_25d4c_dsg,       [3][4] = k_25d5c_dsg,                   // 25    
    [4][0] = k_35d1c_dsg,       [4][1] = k_35d2c_dsg,       [4][2] = k_35d3c_dsg,       [4][3] = k_35d4c_dsg,       [4][4] = k_35d5c_dsg,                   // 35
    [5][0] = k_45d1c_dsg,       [5][1] = k_45d2c_dsg,       [5][2] = k_45d3c_dsg,       [5][3] = NULL,              [5][4] = k_45d5c_dsg,                   // 45
    [6][0] = NULL,              [6][1] = NULL,              [6][2] = NULL,              [6][3] = NULL,              [6][4] = NULL,                          // 55
};
