...
const uint16_t s_cap_list_chg[TEMP_POINT_NUM][CUR_POINT_NUM] = {
    ...
    [2][0] = 1000,      [2][1] = 969,       [2][2] = 1000,      [2][3] = 1000,      [2][4] = 1000,                          // 15
...
const uint16_t s_cap_list_dsg[TEMP_POINT_NUM][CUR_POINT_NUM] = {
    ...
    [0][0] = 1000,      [0][1] = 1000,      [0][2] = 1000,      [0][3] = 1000,      [0][4] = 1000,                          // 0
    [1][0] = 1000,      [1][1] = 1000,      [1][2] = 1000,      [1][3] = 1000,      [1][4] = 1000,                          // 5
    [2][0] = 1000,      [2][1] = 983,       [2][2] = 1000,      [2][3] = 1000,      [2][4] = 1000,                          // 15
    [3][0] = 1024,      [3][1] = 1000,      [3][2] = 1004,      [3][3] = 1000,      [3][4] = 983,                           // 25    
    [4][0] = 1000,      [4][1] = 1000,      [4][2] = 1000,      [4][3] = 1000,      [4][4] = 1000,                          // 35
    [5][0] = 1000,      [5][1] = 1000,      [5][2] = 1000,      [5][3] = 1000,      [5][4] = 1000,                          // 45
    [6][0] = 1000,      [6][1] = 1000,      [6][2] = 1000,      [6][3] = 1000,      [6][4] = 1000,                          // 55
};
...
const uint16_t v_15d2c_dsg[SOC_POINT_NUM] = {        
    2886, 2970, 3029, 3067, 3091, 3107, 3144, 3172, 3191, 3205, 3215, 3223, 3230, 3235, 3240, 3244, 3248, 3253, 3260, 3267, 3272, 3275, 3277, 3278, 3279, 3280, 3281, 3282, 3308
};
const int16_t k_15d2c_dsg[SOC_POINT_NUM] = {
    840, 715, 485, 310, 200, 130, 60, 50, 35, 25, 20, 15, 10, 10, 10, 5, 10, 15, 15, 10, 5, 10, 2, 2, 2, 1, 1, 155, 310
};
...
const uint16_t v_25d1c_dsg[SOC_POINT_NUM] = {  
    2816, 2929, 3005, 3061, 3106, 3139, 3170, 3194, 3217, 3231, 3245, 3255, 3261, 3264, 3267, 3269, 3274, 3283, 3295, 3301, 3304, 3306, 3307, 3308, 3309, 3310, 3311, 3312, 3339      
};
const int16_t k_25d1c_dsg[SOC_POINT_NUM] = {
    1130, 945, 660, 505, 390, 250, 20, 55, 35, 25, 25, 15, 10, 10, 5, 10, 15, 25, 15, 5, 5, 2, 2, 2, 2, 2, 2, 160, 320
};
...
const uint16_t* s_chg_curve[TEMP_POINT_NUM][CUR_POINT_NUM]= 
{
    ...
    [2][0] = NULL,              [2][1] = v_15d2c_chg,       [2][2] = NULL,              [2][3] = NULL,              [2][4] = NULL,                          // 15
...
const int16_t* s_chg_curve_k[TEMP_POINT_NUM][CUR_POINT_NUM] = 
{
    ...
    [0][0] = NULL,              [0][1] = NULL,              [0][2] = NULL,              [0][3] = NULL,              [0][4] = NULL,                          // 0
    [1][0] = NULL,              [1][1] = NULL,              [1][2] = NULL,              [1][3] = NULL,              [1][4] = NULL,                          // 5
    [2][0] = NULL,              [2][1] = k_15d2c_chg,       [2][2] = NULL,              [2][3] = NULL,              [2][4] = NULL,                          // 15
...
const uint16_t* s_dsg_curve[TEMP_POINT_NUM][CUR_POINT_NUM] = 
{
   /*  0.1C                     0.2 C                       0.3 C                      0.4 C                             0.5C                              */
    [0][0] = NULL,              [0][1] = NULL,              [0][2] = NULL,              [0][3] = NULL,              [0][4] = NULL,                          // 0
    [1][0] = NULL,              [1][1] = NULL,              [1][2] = NULL,              [1][3] = NULL,              [1][4] = NULL,                          // 5
    [2][0] = NULL,              [2][1] = v_15d2c_dsg,       [2][2] = NULL,              [2][3] = NULL,              [2][4] = NULL,                          // 15
...
const int16_t* s_dsg_curve_k[TEMP_POINT_NUM][CUR_POINT_NUM] = 
{
    ...
    [0][0] = NULL,              [0][1] = NULL,              [0][2] = NULL,              [0][3] = NULL,              [0][4] = NULL,                          // 0
    [1][0] = NULL,              [1][1] = NULL,              [1][2] = NULL,              [1][3] = NULL,              [1][4] = NULL,                          // 5
    [2][0] = NULL,              [2][1] = k_15d2c_dsg,       [2][2] = NULL,              [2][3] = NULL,              [2][4] = NULL,                          // 15
