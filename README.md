...
在充电中间阶段, 调大 R 值, 使用最优估计 SOC 更相信安时积分模型的计算.
...
![](doc/soh_decrease_temp.png)


组端 SOH 为电芯的平均 SOH.

另外, soh 在满足相应的充放电条件时, 若组端soc发生跳变, soh会进行被动校准(只进行单方向减少).

* 充电全程大于20度以上, 起始充电soc小于 15%, 终止soc发生跳变, soh减小跳变值的 1/10; 单次最大减小1%
* 放电全程大于20度以上, 起始放电soc大于 90%, 终止soc发生跳变, soh减小跳变值的 1/5; 单次最大减小1%
